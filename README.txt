...
> ΕΝΔΕΙΚΤΙΚΕΣ ΕΚΤΕΛΕΣΕΙΣ ΚΑΙ ΑΠΟΤΕΛΕΣΜΑΤΑ (στο zip υπάρχει το αρχείο results.txt το οποίο περιέχει αναλυτικά αποτελέσματα για πολύ μεγάλο πλήθος αρχείων)
        || Local Search (INC)                            || Local Search (CH)                             || Local Step (INC)                              || Local Step (CH)                               || Global Step (INC)                             || Global Step (CH)                              || Subdivision                                   ||
30      || 0.1783    | 0.8861    | 0.1994    | 0.8373    || 0.1661    | 0.9017    | 0.2364    | 0.8918    || 0.3153    | 0.8109    | 0.4239    | 0.6943    || 0.3063    | 0.8266    | 0.5950    | 0.7601    || 0.1894    | 0.8752    | 0.2192    | 0.8596    || 0.2539    | 0.8757    | 0.4766    | 0.8255    || ---       | ---       | ---       | ---       ||

100     || 0.1600    | 0.8545    | 0.1840    | 0.8135    || 0.1722    | 0.8955    | 0.2367    | 0.8576    || 0.2151    | 0.7436    | 0.2820    | 0.7118    || 0.3124    | 0.8171    | 0.4799    | 0.6065    || 0.1707    | 0.8363    | 0.1896    | 0.8010    || 0.1790    | 0.8817    | 0.2471    | 0.8149    || ---       | ---       | ---       | ---       ||

500     || ---       | ---       | ---       | ---       || ---       | ---       | ---       | ---       || 0.1846    | 0.7510    | 0.2247    | 0.7189    || 0.2821    | 0.8259    | 0.4874    | 0.6379    || 0.1519    | 0.8155    | 0.1751    | 0.7879    || 0.1759    | 0.8714    | 0.2632    | 0.7807    || ---       | ---       | ---       | ---       ||

3000    || ---       | ---       | ---       | ---       || ---       | ---       | ---       | ---       || 0.1645    | 0.7450    | 0.1645    | 0.7450    || 0.2555    | 0.9149    | 0.2555    | 0.9149    || 0.1570    | 0.7577    | 0.1570    | 0.7577    || 0.2133    | 0.9160    | 0.2133    | 0.9160    || 0.1307    | 0.7315    | 0.1307    | 0.7315    ||
